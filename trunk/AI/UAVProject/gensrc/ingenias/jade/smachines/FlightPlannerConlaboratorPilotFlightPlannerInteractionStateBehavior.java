...
public class FlightPlannerConlaboratorPilotFlightPlannerInteractionStateBehavior extends StateBehavior{
private MentalStateReader msr=null;
  public FlightPlannerConlaboratorPilotFlightPlannerInteractionStateBehavior( String agentName,
  ...
  if (this.isState("InteractionUnit5")) {
     ...
     try {
      ...
      if (this.getDCC().notifyMessageSent("InteractionUnit5",optionsA,this)){
           ...
           "InteractionUnit5","PilotFlightPlannerInteraction",this.getContentForNextMessage());
           getTimeout().stop();
