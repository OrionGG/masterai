...
public class PilotColaboratorControllerPilotInteracionStateBehavior extends StateBehavior{
private MentalStateReader msr=null;
  public PilotColaboratorControllerPilotInteracionStateBehavior( String agentName,
  ...
  public synchronized void action() {
    ...
    if (this.isState("disabled")){     
     ...
     CommActCreator.generateRWithoutCID((JADEAgent)myAgent,
      "ControllerPilotInteracion","enable",this.getPlayedRole(),options,this);
  ...
  if (this.isState("InteractionUnit1")) {
     ...
     try {
      ...
      if (this.getDCC().notifyMessageSent("InteractionUnit1",optionsA,this)){
           ...
           "InteractionUnit1","ControllerPilotInteracion",this.getContentForNextMessage());
           getTimeout().stop();
