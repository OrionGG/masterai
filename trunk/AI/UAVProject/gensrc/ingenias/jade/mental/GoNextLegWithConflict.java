...
public class GoNextLegWithConflict extends ingenias.editor.entities.RuntimeFact{
   
    Flight_Leg FlightLeg;   
    
   
  public GoNextLegWithConflict (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="GoNextLegWithConflict";
  }
  

  public GoNextLegWithConflict (){
