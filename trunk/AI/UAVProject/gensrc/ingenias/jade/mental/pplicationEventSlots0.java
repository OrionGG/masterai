...
public class pplicationEventSlots0 extends ingenias.editor.entities.RuntimeEvent{
   
    ingenias.jade.AgentExternalDescription PlaneID;   
    
   
   public pplicationEventSlots0 (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="pplicationEventSlots0";
  }
  

  public pplicationEventSlots0 (){
