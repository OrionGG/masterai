...
public class Throw_Instruction extends ingenias.editor.entities.RuntimeFact{
  ...
  public Throw_Instruction (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="Throw_Instruction";
  }
  

  public Throw_Instruction (){
