...
public class PlaneNoMoreInConflict extends ingenias.editor.entities.RuntimeEvent{
   
    ingenias.jade.AgentExternalDescription PlaneID;   
    
   
   public PlaneNoMoreInConflict (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="PlaneNoMoreInConflict";
  }
  

  public PlaneNoMoreInConflict (){
