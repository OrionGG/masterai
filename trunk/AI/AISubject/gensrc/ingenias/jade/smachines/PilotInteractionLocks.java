...
*/
			...
			public class PilotInteractionLocks implements CustomLocks {
			
			public PilotInteractionLocks(){};
                  ...
                  if (interaction.equals("PilotPlaneInteraction")&& role.equals("Initiator")){
                    InitiatorPilotPlaneInteractionDefaultCommControl.addDefaultLocks(lw);
                  }
