...
public class Unmanned_Autonomous_PilotJADEAgent
		 extends JADEAgent {         
 
		 public Unmanned_Autonomous_PilotJADEAgent(){
		 super(new Unmanned_Autonomous_PilotProtocol(),new Unmanned_Autonomous_PilotInteractionLocks());
		 }
