...
public class PlaneProtocol implements AgentProtocols{

public PlaneProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("PilotPlaneInteraction") && conv.getPlayedRole().equals("Colaborator")){
		   	DefaultCommControl dcc=new ColaboratorPilotPlaneInteractionDefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new ColaboratorPilotPlaneInteractionStateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
