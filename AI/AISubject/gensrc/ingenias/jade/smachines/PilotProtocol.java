...
public PilotProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("PilotPlaneInteraction") && conv.getPlayedRole().equals("Initiator")){
		   DefaultCommControl dcc=new InitiatorPilotPlaneInteractionDefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new InitiatorPilotPlaneInteractionStateBehavior(
			agentName,
				msr,msu,
					conv,                           		
				   conv.getPlayedRole(),
