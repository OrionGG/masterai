...
public class Altitude_Change extends ingenias.editor.entities.RuntimeFact{
   
    Integer Feet;   
    
   
  public Altitude_Change (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="Altitude_Change";
  }
  

  public Altitude_Change (){
