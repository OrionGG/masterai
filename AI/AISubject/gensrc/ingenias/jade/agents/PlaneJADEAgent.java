...
public class PlaneJADEAgent
   ...
   sg= new ingenias.editor.entities.StateGoal("Safe_Fuel");
   sg.setState("pending");
      try {
   ...
   /* */
	...
	Vector evetns=null;
     ...
     this.getAM().addApplication("Add_Degrees_To_Head",app);        
	 events=new Vector();
	 actions=new Vector();

	 if (getGraphics()!=null)
	  getGraphics().addApplication("Add_Degrees_To_Head", events,actions);    
