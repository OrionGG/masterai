...
public class OrderPositionAndPlan extends ingenias.editor.entities.RuntimeFact{
  ...
  public OrderPositionAndPlan (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="OrderPositionAndPlan";
  }
  

  public OrderPositionAndPlan (){
