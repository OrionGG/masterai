...
public class InitializePlaneMind extends ingenias.editor.entities.RuntimeFact{
   
    enums.Airport InitialAirport;   
    
   
  public InitializePlaneMind (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="InitializePlaneMind";
  }
  

  public InitializePlaneMind (){
